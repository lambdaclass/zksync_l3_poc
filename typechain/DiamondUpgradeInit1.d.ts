...
interface DiamondUpgradeInit1Interface extends ethers.utils.Interface {
  functions: {
...
export class DiamondUpgradeInit1 extends Contract {
  ...
  interface: DiamondUpgradeInit1Interface;
