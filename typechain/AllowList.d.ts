...
interface AllowListInterface extends ethers.utils.Interface {
  functions: {
    ...
    "tokenDeposit(address)": FunctionFragment;
...
export class AllowList extends Contract {
  ...
  getAccessMode(arg0: string, overrides?: CallOverrides): Promise<number>;
  ...
  estimateGas: {
    ...
    getAccessMode(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    tokenDeposit(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
