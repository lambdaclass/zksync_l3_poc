...
interface DiamondUpgradeInit6Interface extends ethers.utils.Interface {
  functions: {
    "finalizeEthWithdrawal(uint256,uint256,uint16,bytes,bytes32[])": FunctionFragment;
    "forceDeploy(bytes,bytes,bytes[])": FunctionFragment;
...
export class DiamondUpgradeInit6 extends Contract {
  ...
  interface: DiamondUpgradeInit6Interface;
