...
interface L1ERC20BridgeTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getZkSyncMailbox()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getZkSyncMailbox",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class L1ERC20BridgeTest extends Contract {
  ...
  functions: {
    ...
    getZkSyncMailbox(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  getZkSyncMailbox(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    getZkSyncMailbox(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getZkSyncMailbox(overrides?: CallOverrides): Promise<PopulatedTransaction>;
