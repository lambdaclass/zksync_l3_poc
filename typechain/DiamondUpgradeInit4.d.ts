...
interface DiamondUpgradeInit4Interface extends ethers.utils.Interface {
  functions: {
...
export class DiamondUpgradeInit4 extends Contract {
  ...
  interface: DiamondUpgradeInit4Interface;
