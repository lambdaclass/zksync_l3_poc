...
interface DiamondUpgradeInit5Interface extends ethers.utils.Interface {
  functions: {
...
export class DiamondUpgradeInit5 extends Contract {
  ...
  interface: DiamondUpgradeInit5Interface;
